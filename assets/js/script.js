...
// grabing a random item from the arrays used to make up the password  
...
function generatePassword() {
    ...
    // setting user answers from propts to a variable,. returning the answer in lower case always
